...
Using Elasticsearch or OpenSearch as the FA search provider gives users more powerful features, like:
...
<Aside type="note">
FusionAuth supports Elasticsearch and OpenSearch with the same features. You can choose whichever you prefer. This guide uses "Elasticsearch" as a general term.
</Aside>
