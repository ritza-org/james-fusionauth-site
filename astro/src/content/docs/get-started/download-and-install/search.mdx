...
![The FusionAuth admin UI showing the basic database search for users.](/img/docs/get-started/download-and-install/search/basicSearch.webp)
...
![The FusionAuth admin UI showing the advanced Elasticsearch search for users.](/img/docs/get-started/download-and-install/search/elasticSearch.webp)
...
![The FusionAuth admin UI showing the Reindex page under System.](/img/docs/get-started/download-and-install/search/reindex.webp)
...
![The FusionAuth admin UI showing the About page with the search engine type displayed.](/img/docs/lifecycle/manage-users/search/about-search-engine-type.png)
