...
<LocalCode src="quickstart-django-web/complete-application/requirements.txt" lang="shell" />
...
<LocalCode src="quickstart-django-web/complete-application/mysite/.env" lang="shell" />
...
<LocalCode src="quickstart-django-web/complete-application/mysite/mysite/settings.py" lang="python" />
...
<LocalCode src="quickstart-django-web/complete-application/mysite/mysite/urls.py" lang="python" />
...
<LocalCode src="quickstart-django-web/complete-application/mysite/app/urls.py" lang="python" />
...
<LocalCode src="quickstart-django-web/complete-application/mysite/app/views.py" lang="python" />
