...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/public/login.php"} lang="php"/>
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/public/logout.php"} lang="php"/>
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/public/static/changebank.css"} lang="css"/>
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/public/index.php"} lang="php"/>
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/public/account.php"} lang="php"/>
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/public/change.php"} lang="php"/>
