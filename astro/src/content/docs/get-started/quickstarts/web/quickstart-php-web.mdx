...
htmlTitle: FusionAuth QuickStart for PHP
...
<Intro technology="PHP" repositoryUrl={frontmatter.url}/>
...
<DockerSpinup kickstartUri="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-php-web/main/kickstart/kickstart.json" />
...
Authentication in PHP is managed by [FusionAuth community member Jerry Hopper's FusionAuth Provider](https://github.com/jerryhopper/oauth2-fusionauth) for [The League's OAuth library](https://github.com/thephpleague/oauth2-client).

Create an `.env` file within `your-application` directory and insert the following lines.

<LocalCode src="quickstart-php-web/complete-application/.env" lang="shell"/>
...
<LocalCode src="quickstart-php-web/complete-application/public/login.php" lang="php"/>
...
<LocalCode src="quickstart-php-web/complete-application/public/logout.php" lang="php"/>
...
<LocalCode src="quickstart-php-web/complete-application/public/static/changebank.css" lang="css"/>
...
<LocalCode src="quickstart-php-web/complete-application/public/index.php" lang="php"/>
...
<LocalCode src="quickstart-php-web/complete-application/public/account.php" lang="php"/>
...
<LocalCode src="quickstart-php-web/complete-application/public/change.php" lang="php"/>
