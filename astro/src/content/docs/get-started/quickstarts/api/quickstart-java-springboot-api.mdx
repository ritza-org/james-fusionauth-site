...
<LocalCode src="fusionauth-quickstart-java-springboot-api-main/complete-application/src/main/resources/application.properties" lang="ini" />
...
<LocalCode src="fusionauth-quickstart-java-springboot-api-main/complete-application/src/main/java/io/fusionauth/quickstart/springapi/PanicResponse.java" lang="java" />
...
<LocalCode src="fusionauth-quickstart-java-springboot-api-main/complete-application/src/main/java/io/fusionauth/quickstart/springapi/Change.java" lang="java" />

### Add Controllers

Next you need to add controllers to handle API calls. In the base package add a new class `MakeChangeController.java`.

<LocalCode src="fusionauth-quickstart-java-springboot-api-main/complete-application/src/main/java/io/fusionauth/quickstart/springapi/MakeChangeController.java" lang="java" />
...
<LocalCode src="fusionauth-quickstart-java-springboot-api-main/complete-application/src/main/java/io/fusionauth/quickstart/springapi/PanicController.java" lang="java" />
...
<LocalCode src="fusionauth-quickstart-java-springboot-api-main/complete-application/src/main/java/io/fusionauth/quickstart/springapi/CustomJwtAuthenticationConverter.java" lang="java" />
...
<LocalCode src="fusionauth-quickstart-java-springboot-api-main/complete-application/src/main/java/io/fusionauth/quickstart/springapi/SecurityConfiguration.java" lang="java" />
