...
import DotNetPreReqs from 'src/components/quickstarts/dotnet-prereqs.mdx';
...
<LocalCode src="fusionauth-quickstart-dotnet-api/complete-application/appsettings.json" lang="json" />

Replace the code in the `appsettings.Development.json` file with the following.

<LocalCode src="fusionauth-quickstart-dotnet-api/complete-application/appsettings.Development.json" lang="json" />
...
<LocalCode src="fusionauth-quickstart-dotnet-api/complete-application/Program.cs" lang="csharp" />
...
<LocalCode src="fusionauth-quickstart-dotnet-api/complete-application/Models/PanicResponse.cs" lang="csharp" />
...
<LocalCode src="fusionauth-quickstart-dotnet-api/complete-application/Models/Change.cs" lang="csharp" />
...
<LocalCode src="fusionauth-quickstart-dotnet-api/complete-application/Controllers/MakeChangeController.cs" lang="csharp" />
...
<LocalCode src="fusionauth-quickstart-dotnet-api/complete-application/Controllers/PanicController.cs" lang="csharp" />
