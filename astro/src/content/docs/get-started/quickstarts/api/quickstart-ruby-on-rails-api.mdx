...
<LocalCode src="quickstart-rails-api/complete-application/Gemfile" lang="text" />
...
<LocalCode src="quickstart-rails-api/complete-application/config/routes.rb" lang="ruby" />
...
<LocalCode src="quickstart-rails-api/complete-application/config/initializers/jwt_rack.rb" lang="ruby" />
...
<LocalCode src="quickstart-rails-api/complete-application/app/controllers/make_change_controller.rb" lang="ruby" />
...
<LocalCode src="quickstart-rails-api/complete-application/app/controllers/panic_controller.rb" lang="ruby" />
