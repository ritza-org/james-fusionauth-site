...
<Intro technology="Ruby on Rails"
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-api/complete-application/Gemfile" lang="text" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-api/complete-application/config/routes.rb" lang="ruby" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-api/complete-application/config/initializers/jwt_rack.rb" lang="ruby" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-api/complete-application/app/controllers/make_change_controller.rb" lang="ruby" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-api/complete-application/app/controllers/panic_controller.rb" lang="ruby" />
...
Acquire an access token for `teller@example.com` by making the following request
